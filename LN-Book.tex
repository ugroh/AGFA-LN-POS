...
%\usepackage{imakeidx}
%\makeindex[columns=2, options=-s svind.ist]                      % please use the style svind.ist with
...
%,author-final/part-0/ln-symbols
%% -- Part A
%% --
...
\frontmatter%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% -- part-0
\include{author-final/part-0/ln-dedication}
%\include{author-final/part-0/foreword}
\include{author-final/part-0/ln-preface}
%\include{author-final/part-0/acknowledgement}
%%
\tableofcontents
%%
\include{author-final/part-0/ln-symbols}
%%
%%
\mainmatter%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
