...
(\lnm ii) of Theorem  \ref{thm:a2-1.7} (\lnm 1.2). (see [Davies (1980)], [Goldstein (1985b)] or [Pazy [1982]).
...
Differentiable semigroups are treated in detail in the book of [Pazy (1983)] who discovered Theorem \ref{thm:a2-1.17} (\lnm 1.17) and \ref{thm:a2-1.18} (\lnm 1.18).
...
Theorem \ref{thm:a2-1.29} (\lnm 1.29) on the perturbation by bounded operators is due to [Phillips (1953)] who also investigated permanence of smoothness properties by this kind of perturbation.
...
The proof of Lemma \ref{lem:a2-3.1} (\lnm 3.1) was communicated to the author by T. Coulhon, who independently obtained a particular case ([Coulhon (1984)]).
