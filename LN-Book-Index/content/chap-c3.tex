% !TEX root = ../LN-Index.tex
%% -- 
%% --Stand 2025-11-28
%% -- Stand: 2025-12-03 KGK Indexanpassung
%% -- Stand: 2025-12-05 KGK Indexanpassung
%% --
...
%%KGK
%	\index{resolvent!positive semigroup}
...
%%KGK
%\index{cyclic!imaginary additively}
\index{spectrum!cyclic}
%%KGK angepasst "point" an "point spectum"    
\index{spectrum!point spectrum}
%%KGK
%\index{cyclic!point spectrum}
...
%%KGK
%\index{resolvent!growth condition}
...
%%KGK
%\index{cyclic!boundary spectrum}%
    \index{spectrum!cyclic} 
...
%%KGK
%\index{example!elliptic operator}
...
\begin{enumerate}[\upshape (i), wide, labelindent=.5em]	
	...
	One can go even further and consider positive pseudo-resolvents\index{pseudo-resolvent} $\{R(\lambda)\}_{\lambda\in D}$.
...
%%KGK
%	\index{example!irreducible semigroups}
	\begin{enumerate}[\upshape (i), wide, labelindent=.5em]
%%KGK
%	\item \index{example!kernel operator}
...
%%GG\index{boundary spectrum!irreducible semigroup}
\index{resolvent!pole}
...
\index{transport equation} 
once again, see Example~\ref{ex:c3-3.4}(d).
...
\begin{proof}
	...
	\end{equation}
	%% --
	In fact, A-I,\,(3.1) implies $(\eu^{rt} - T(r))R(r,A) \geq 0$ hence 
    \[
...
%%KGK
%\index{example!ordinary differential equation}
