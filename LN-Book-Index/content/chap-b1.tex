...
%%GG\index{CoX@$C_{0}(X)$!Algebraic Structure}%
%%GG\index{CoX@$C_{0}(X)$!Order Structure}%
%%GG\index{CoX@$C_{0}(X)$!Ideals}
%% --
...
%%GG\index{CoX@$C_{0}(X)$!Linear Forms}
%%GG\index{CoX@$C_{0}(X)$!Positive linear forms}
%%GG\index{CoX@$C_{0}(X)$!Strictly positive linear Forms}
%% --
...
%%GG\index{CoX@$C_{0}(X)$!Linear Operators}%
%%GG\index{CoX@$C_{0}(X)$!Positive Linear Operators}%
%%GG\index{CoX@$C_{0}(X)$!Markov Operator}%
%%GG\index{CoX@$C_{0}(X)$!Lattice Homomorphisms}
%% --
