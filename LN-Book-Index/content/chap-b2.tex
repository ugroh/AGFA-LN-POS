...
%% -- Stand: 2025-12-04 KGK Indexanpassung
%% --
\setcounter{chapter}{1}
%\chapternopage{Characterization of Positive Semigroups on \texorpdfstring{$C_{0}(X)$}{C\textunderscore 0(X)}}
\chapter{Characterization of Positive Semigroups on $C_{0}(X)$}
\label{chap:b2}%
%%GG\index{$C_{0}(X)$!Positive Semigroups}
%% --
{\Large
\vspace*{-.75cm}
by \\[.25em]
...
%%GG\index{$C(K)$!Positive Semigroups!Generators}
%% --
...
%%
%%KGK kleinschreiben - singular
%%GG\index{operator!resolvent monotonicity}
...
%%
%%KGK kleinschreiben
%%GG\index{growth bound!positive semigroup}
...
%%
%%KGK kleinschreiben
%%GG\index{positive semigroup!strict positivity}
...
%%GG\index{$C_{0}(X)$!Lattice semigroups}
%%
...
%%
%%GG\index{Gateaux differentiability!chain rule}
...
\begin{align*}
(M(2w - 1))^{-1} &= \int_{0}^{\infty} \eu^{-ws}(M\eu^{(w-1)s})^{-1} \ds \\ 
&\leq p(x) \\ 
...
%
%%KGK kleinschreiben
%%GG\index{flow!stationary point}
...
%
%%KGK kleinschreiben
%%GG\index{flow!characterization}
...
%
%%GG\index{admissible function!initial value problem}
