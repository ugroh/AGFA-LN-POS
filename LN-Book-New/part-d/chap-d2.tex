...
\end{enumerate}
%% --
For the following construction see Part-I, Chapter 1,  3.7 and Chapter~\ref{chap:d2},  Sec.2.
Take
%% --
\begin{enumerate}[\upshape (i)]
\item
...
\]
%% --
From Lemma~\ref{lem:d3-1.1}., we conclude $T(ux) = uT(x)$ and $T(xu^{*}) = T(x)u^{*}$ for all $x \in \widehat{M}$.
Hence
%% --
\begin{align*}
