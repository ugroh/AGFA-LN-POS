...
To do this we call a triple $ (M,\phi,\TT) $  a \WA-dynamical system if\/ $ M $  is a \WA-algebra, $ \TT$ a weak*-semigroup of identity preserving Schwarz maps on $ M $  and $ \phi $  is a faithful \/ $ \TT $-invariant normal states.
We call $ (M,\phi,\TT) $  irreducible, if the preadjoint semigroup is irreducible (equvalently, if the fixed space of\/ $ \TT $  is one dimensional).
%% --
