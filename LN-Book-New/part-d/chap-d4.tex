...
\]
%% --
contains a unique minimal ideal $K$, called the kernel of\/ $\mathcal{S}$, which is a compact Abelian group (\textcite{deleeuw:1961}, \textcite{junghenn:1971} \& \textcite[§ 2.4]{krengel:1985}).
...
Let $K$ be the semigroup kernel of\/ $\closure{\TT} \subset \mathcal{L}_{w}{(M_{*})}$ and $Q$ the unit of\/ $K$.
...
\]
%
is a representation of the compact, Abelian group $K$ as group of *-automorphism such that the fixed space is one dimensional.
