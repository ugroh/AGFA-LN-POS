...
\end{align*}
%% --
(see Part-IV, Chapter 1,  Corollary~\ref{cor:d1-2.2}).
Since
%% --
\begin{align*}
\|\psi\| &= \| |\psi| \| = |\psi|(\1) = \\
...
%% --
\begin{proof}
By Remark~\ref{rem:d4-3.2}.c, we may assume without loss of generality that there exists a faithful family of\/ $\RR$-invariant normal states on $M$.
