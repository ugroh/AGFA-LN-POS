...
%% --
\[
\|\widehat{x}\| = \lim_{\mathfrak{U}}\|x_{n}\| \, , \, (x_{n}) \in \widehat{x} \in \widehat{E}.
\]
%% --
...
%% --
\[
\widehat{\RR} \coloneqq (\lambda \mapsto R(\lambda)^{\wedge}): D \to L(\widehat{E})
\]
%% --
...
%% --
\[
	\|\widehat{x}_{j} - \widehat{x}_{\ell}\| \leq \frac{\delta}{2} .
\]
%% --
...
%% --
\[
 0 \leq \gamma \leq \|\widehat{z} - \widehat{x}\| = \lim \|z - x_{n}\| = 0
\]
%% --
Consequently,
%% --
...
From the construction the following is obvious: If\/ $T$ is an identity preserving Schwarz map with preadjoint $T_{*} \in L(M_{*})$, then $\widehat{T}$ is an identity preserving Schwarz map on $\widehat{M}$ such that $(T_{*})^{\wedge} = \widehat{(T)}{}'_{\vert (M_{*})^{\wedge}}$.
\end{enumerate}
\end{remarks}
%\newpage
%% -- d3-20
