...
%% --
%% Last updated by FN on 3/15/2026 at 22:42 CST.
...
In this case, one may apply Eq.~\myeqpageref{eq:a4-1.7} to obtain the stronger statement Eq.~\myeqpageref{eq:a4-1.8}.\marginpar{ulgr: on the same page}
...
The operator $A = \frac{d}{dx}$ with domain $D(A) = \{f \in E: f' \in C^{1} \text{ and } f' \in E\}$ is the generator of the uniformly stable translation semigroup $T(t)f(x) \coloneqq f(t+x)$. 
