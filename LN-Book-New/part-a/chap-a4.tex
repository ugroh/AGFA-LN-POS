...
As discussed in Part-I, Chapter 3,  the situation becomes significantly more intricate in the infinite-dimensional setting. 
...
If\/ $\frac{2\pi in}{p} \in \rho(A)$ for every $n \in \Z$, then, by Lemma \ref{lem:a4-2.2}, Eq.~\eqref{eq:a4-2.1}
