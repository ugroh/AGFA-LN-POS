...
We will see in Part-III, Chapter 4 that for positive semigroups a condition similar to statement (ii) below is even sufficient for stability. 
...
Corollary~1.13 in Chapter~Part-I, Chapter 2).
\index{operator!Laplacian}
...
However, if the
semigroup is positive, these results remain valid even under the weaker assumption of stability (see Section Part-3, Chapter 4 ).
