...
%%
\[
\sigma(A) = [\text{ess}]\text{-}\text{image}(m) \coloneq \{\lambda \in \C \colon \mu(\{x \in X \colon |m(x)-\lambda| < \epsilon\}) \neq 0 \text{ for all } \epsilon > 0\} 
\]
%% 
...
and%
\[
	 H \coloneq \{m(x) \colon \Re(\lambda) \geq b \text{ and for all } \eta > 0,  
...
%%
\[
E_{p} \coloneq \{f \in E \colon p(-f) \geq 0\}
\] 
%%
on $E$.
