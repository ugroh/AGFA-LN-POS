...
In case that $\sigma_{b}(A)$ is cyclic one has the alternative (\cf Eq.~\eqref{eq:b3-2.19})
%% --
\[
...
It follows from Proposition~\ref{prop:c3-3.3} that $(S(t))$ is irreducible and we have $S(t) = T(t) + \int_{0}^{t} T(t-s)KS(s)\ds$ (see Eq.~\eqref{eq:a2-1.9}). 
