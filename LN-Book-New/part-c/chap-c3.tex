...
%% --
\begin{proof} 
To prove equivalence of Eq.~\myeqpageref{eq:c3-2.15}(a) and Eq.~\myeqpageref{eq:c3-2.15}(b), we assume $s(A) = 0$ and write $C(t) \coloneqq \frac{1}{t} \int_{0}^{t} T(\tau) \diff{\tau}$.
...
From Eq.~\myeqpageref{eq:c3-3.5} and Eq.~\myeqpageref{eq:c3-3.6} one deduces that 
%% --
\[
