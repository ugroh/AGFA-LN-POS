...
%% --
In Part-II, Chapter 3 we showed that positive semigroups on spaces $C_{0}(X)$ possess several interesting spectral properties.
...
Furthermore, Corollary~1.3 and Proposition~1.5 of Part-II, Chapter 3 are true in the setting of Banach lattices and their proofs can be extended to the general case.
...
\end{theorem}
%% --
The fact that $s(A)$ is always an eigenvalue of the adjoint (\cf Part-II, Chapter 3 Theorem~1.6) is characteristic for spaces $C(K)$, $K$ compact, as can be seen by considering the Laplacian on $L^p(\R^n)$, where $1 < p < \infty$, or on $C_{0}(\R^n)$ (see Part-II, Example~\ref{ex:b3-1.7}).
...
\index{spectrum!boundary|(} 
%% --
In Part-II, Chapter 3we have seen that under suitable assumptions the boundary spectrum $\sigma_{b}(A)$, consisting of all spectral values with maximal real part is a cyclic set (\cf Part-II, Definition~\ref{defn:b3-2.5}).
...
We first want to extend some of the notions used in Part-II, Chapter 3 to the more general setting considered here.
