...
For more general generators of the type Eq.~\eqref{eq:c4-2.2} we refer to Part-III, Chapter 4,  Section~3.
\end{example}
...
\end{proof}
%% --
The following corollary corresponds to Part-II, Chapter 4,  Corollary~3.2 and assures the well-posed\-ness of Eq.~\eqref{eq:c4-re}.
...
%% --
\begin{proof}
As in the proof of Part-II, Chapter 4,  Corollary 3.2 we have $u_t = T(t)f$ for $t \geq 0$ since $u_t(s) = u(t+s) = (T(t)f)(s)$ by the definition of\/ $u$ and by formula Eq.~\eqref{eq:c4-3.3}.
