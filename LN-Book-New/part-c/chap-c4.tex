...
We call the identity\, \enquote{$s(\Phi_{\lambda}) = 1$} a \emph{generalized characteristic equation} (see also the remark following B-IV, Theorem~3.7). The usual characteristic equation (see for example  \textcite[p.168ff]{hale:1977} and \textcite[Section~5]{heijmans:1985b}
...
Initiated by Hale's semigroup approach (see B-IV, Sec.3) to retarded differential equations, \textcite{dysonvillella:1979}, \textcite{villellabressan:1985} and \textcite{webb:1977} used such methods to investigate retarded equations.
