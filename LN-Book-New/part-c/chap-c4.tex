...
From C-III, Corollary~3.9 we conclude that  $P\sigma(A_j) \cap \im\R = {0}$\,. 
...
\index{operator!kernel}
Corollary \ref{cor:c4-2.11} remains true when the assumption \enquote{$T(t)$ is a kernel operator} is replaced by \enquote{$T(t)$ is an irreducible Harris operator} (see \citet{lin:1974}).
