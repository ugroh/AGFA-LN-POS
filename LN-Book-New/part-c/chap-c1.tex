...
If two ideals $ I $ and $ J $ of a vector lattice $ E $ have trivial intersection $ \{0\} $, then $ I $ and $ J $ are \emph{lattice disjoint}, \ie $ I \subset J^{d} $.
...
%% --
\[
	|\phi|(f) \coloneqq \sup\{\phi(h) \colon |h| \leq f \text{ for $ f \in E_{+} $}\}.
\]
%% --
