...
\item
The $\F$-product in Part-I, Chapter 1 Section~3.6 and the corresponding extension of a $C_{0}$-semigroup is a special case of the so-called \emph{ultraproduct construction} of Banach spaces (see, \eg \textcite{zbmath03640303} or \textcite{zbmath03987965}).
...
\mbox{Chapter 3.6.6}, was started with the aforementioned work of \textcite{derndingerEN:1980} and extended in \textcite{zbmath069217}.
...
Here we mention the following version of the Lumer-Phillips Theorem (Part-I, Chapter 2,  Theorem~2.11). 
...
%The problem to determine all m-disipative operators of a given dissipative operator is considered in \textcite{zbmath07950102}.

\item 
The problem mentioned at the end of Part-I, Chapter 2, 1.6 has been solved on Hilbert spaces by \textcite{zbmath00126068}. 
...
Using this, \textcite{zbmath00701021} gives a characterization of eventual norm continuity for semigroups on Hilbert spaces in terms of their generators.

\item
For Lotz's Theorem (Part-I, Chapter 2,  Theorem 3.5) to hold, the operator $A$ need not be the generator of a semigroup. 
...
\item
The validity or failure of the spectral mapping theorem discussed in Part-I, Chapter 3,  Section 6 and 7 
%% --
\[
...
We refer to \textcite[Section 2]{zbmath00921898} or 
\textcite[Chapter IV]{zbmath01354832} for a systematic and more recent study. 
...
\textcite{zbmath00410037} and \textcite{zbmath0493176} characterize countability of the boundary spectrum in terms of \enquote{super stability} (\ie stability of the semigroup induced on an ultra power of the underlying Banach space).
...
\item 
There are several criteria known which imply the strong stability of a semigroup (i.e. strong convergence of $T(t)$ to $0$ as $t \rightarrow \infty$), see e.g. \textcite{zbmath05136549}.
Quantative estimates of the decay of the semigroup in terms of decay estimates of the resolvent are given in \textcite{zbmath05562661}, with a complete characterization on Hilbert spaces by \textcite{zbmath05700559}. 
