...
Here we mention the following version of the Lumer-Phillips Theorem (Part-I, Theorem~\ref{thm:a2-2.11}):  
...
\item 
The problem mentioned at the end of \textbf{Part-I, Section~\ref{sec:a3-6}} has been solved on Hilbert spaces by \textcite{zbmath00126068}. 
...
\item
For Lotz's Theorem (Part-I, Theorem~\ref{thm:b2-3.5}) to hold, the operator $A$ need not be the generator of a semigroup. 
