...
The proof of Theorem~\ref{thm:b2-1.13} yields estimates for the growth bound of a positive semigroup (see Eq.~\myeqpageref{eq:b3-1.3} ) which we state explicitly in the next corollary.
