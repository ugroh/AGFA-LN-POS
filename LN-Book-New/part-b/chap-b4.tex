...
In Example~\ref{ex:a4-1.2}\,(ii), we have seen that for the generator $A$ of the (positive) translation semigroup on the Banach lattice $C_{0}(\R_+) \cap L^1(\R_+,\eu^x \diff{x})$ the strict inequality 
