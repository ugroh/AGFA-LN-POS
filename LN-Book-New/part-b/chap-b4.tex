...
%%
\[
|\langle T(t)f,\mu \rangle| = |\langle f,\mu \rangle|   \geq  0
\]
%%
...
\begin{equation}\label{eq:b4-2.8}
  \begin{aligned}
    Af   &\coloneqq -f' + mf, \quad \text{with domain } D(A) \text{ given by} \\
    D(A) &\coloneqq \bigl\{ f \in C_0(X) \colon f \text{ is differentiable},\;
                    f' \in C_0(X), \\
         &\phantom{{}\coloneqq \bigl\{}
