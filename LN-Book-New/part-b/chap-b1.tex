...
We will occasionally make use of the order structure of\/ $C_{0}(X)'$, but since at least its measure theoretic interpretation is supposed to be well-known, it may suffice here to refer to Part-III, Chapter 1,  Sections 3 and 7, for a more detailed discussion.
