...
Our goal at the time was to provide a systematic and accessible account of the foundation and structure theory of positive semigroups, with particular emphasis on Banach lattices and $C^*$-algebras. 
...
Obvious misprints have been corrected, references have been updated where appropriate, and the notes at the end of each chapter have been significantly expanded in a new chapter entitled \emph{Updated Notes} to highlight subsequent developments. 
...
For example, a result cited in the first edition as \emph{A–III} now appears as \emph{Part-I, Chapter~2}. 
...
\begin{minipage}[c]{0.45\textwidth}
  \raggedright{\includegraphics[width=\linewidth]{./part-0/apparaetle.jpg}}
\end{minipage}
\hfill
