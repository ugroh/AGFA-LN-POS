...
This also follows from the example given above above and the fact that the Hilbert space $H$ can be identified with a direct factor of $\BH$.
...
%% --
As in Part-IV, Chapter~\ref{chap:d4},  results from \textcite{zbmath07964911} on semigroups on ordered Banach spaces with a normal cone and order unit can be applied. 
