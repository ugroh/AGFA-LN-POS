...
\begin{split}
\omega_{1}(A) &= \inf\{\Re(\lambda) \colon {\int_{0}^{\infty} \eu^{-\lambda t} T(t)f  \dt} 
	\text{ exists as an improper Riemann integral for every } f \in E\} \\
...
$\| R(\lambda, -b+A) \| \leq \tilde{C} | \lambda |^{n-2}$ for every $\lambda \in \C$ with $\Re  \lambda > q-b$ and $| \text{Im } \lambda | > a+2b$, for a suitable constant $\tilde{C}$. 
