...
The proof of Hille (see \citet{kato:1976}) is inspired by the following formula.
\index{Hille-Yosida theorem|)}
%%
...
A very elegant brief introduction to one-parameter semigroups is given in the treatise of \citet{kato:1976} where one can also find all the results on perturbation theory going beyond the elementary facts we discuss here.
