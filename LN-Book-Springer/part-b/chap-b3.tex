...
\index{cyclic}
%%KGK
%\index{example!imaginary additively cyclic}
...
%	%
%%GG\index{boundary spectrum!eigenvalues}
...
%% --
\begin{proof}
	We can assume that $s(A) = 0$ and we will denote the negative coefficients of the Laurent series\index{resolvent!Laurent serie} of $R(\cdot,A)$ at $0$ by $Q_{n}$.
...
%%KGK
%\index{spectral value!strictly dominant}  
...
%%KGK
%\index{semigroup!compact resolvent}	
%% neu
...
%
%%KGK
%\index{example!non-cyclic point pectrum}
%% --
...
%
%%KGK
%\index{example!irreducible semigroup}
	
\begin{enumerate}[\upshape (i), wide, labelindent=.5em]
	\item 
	(cf.\ B-II, Section~3). Suppose $(T(t))_{t\geq 0}$ is governed by a continuous semiflow\index{semiflow} $\phi \colon \R_{+} \times X \to X$, \ie $T(t)f = f\circ\phi_{t}$ $(f\in C_{0}(X))$.
...
%%KGK
%\index{example!lattice homomorphisms}
	\begin{enumerate}[\upshape (i), wide, labelindent=.5em]
	\item 
...
%%KGK
%    \index{lattice homomorphism!group of}
