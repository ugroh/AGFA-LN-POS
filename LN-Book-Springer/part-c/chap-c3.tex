...
\end{proof}
%% --
The spectrum of a positive semigroup may be empty (see B-III, Example~1.2(i)) and the spectrum of a general group may be empty as well (see \citet[Section~23.16]{hillephillips:1957}).
...
\citet{krasnoselskii:1964} or \enquote{quasi-strictly positive} in \citet{karlin:1959}). \citet{sawashima:1964} uses \enquote{non-support} instead of irreducible. 
...
Theorem~\ref{thm:c3-3.7} and Example~\ref{ex:c3-3.6} are taken from \citet{schaefer:1985}. 
...
Lemma~\ref{lem:c3-3.10} is taken from \citet{groh:1984b} and Theorems~\ref{thm:c3-3.12} and \ref{thm:c3-3.14} can be found (with slightly different proofs) in \citet{greiner:1981}. 

\item 
It was \citet{derndinger:1980} who proved Theorem~\ref{thm:c3-4.2}. 
