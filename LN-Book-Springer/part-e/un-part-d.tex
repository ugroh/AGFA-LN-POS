...
\begin{enumerate}
\item 
By \mycite[Theorem 5.3.1]{zbmath03736445}] one has $s(A) \in \sigma(A)$ whenever $A$ generates a positive semigroup on an ordered Banach space with normal cone and if the spectrum of $A$ is non-empty. Moreover, $s(A) = \omega_{0}$ if the norm is additive on the dual positive cone, see 
\mycite[Theorem 2.4.4]{zbmath03883065}. 
