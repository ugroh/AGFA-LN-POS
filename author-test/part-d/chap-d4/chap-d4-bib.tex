...
Since $Q \in T^{-} \subseteq L_{w}(M_{*})$ there exists an ultrafilter $\mathfrak{U}$ on $\R_{+}$ such that 
%
\[
...
$Q'$ is faithful, \ie $\Kern{Q'} \cap M_{+} = \{0\}$ since $Q\phi = \phi$ for the faithful linear form $\phi$.
%% --
%\newpage
%% -- d4-14
