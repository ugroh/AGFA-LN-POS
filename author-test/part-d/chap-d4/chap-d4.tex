...
\]
%% --
it follows that $\omega_{0}(\TT) = 2\omega_{0}(U)$.
...
\end{proof}
%% --
\noindent For irreducible \WA-dynamical systems on $ \BH $  the above properties always hold.
%% --
...
If $ H_{0} \coloneqq \Kern(Q) \subseteq H_{\phi} $  then it is easy to see that $ H_{0} $  is invariant under the extension to $ H_{\phi} $  of the multiplication maps we defined in D-III, Remark 1.3.
