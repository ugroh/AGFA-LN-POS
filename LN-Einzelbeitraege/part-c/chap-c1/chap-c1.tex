%% Stand 2025-05-09 ulgr
%% Index überarbeitet, Kleinigkeiten korrigiert
%% --
\chapter{Basic Results on Banach Lattices and Positive Operators}\label{chap:c1}
\index{Banach Lattices}
...
\index{Banach Lattices!Sublattices}
\index{Banach Lattices!Ideals}
\index{Banach Lattices!Bands}
...
\index{Banach Lattices!Order Units}
\index{Banach Lattices!Weak Order Units}
\index{Banach Lattices!Quasi-Interior Points}
...
\index{Banach Lattices!Linear Forms}
%% --
...
\index{Banach lattices!AM-Spaces}
\index{Banach lattices!AL-Spaces}
%% --
...
\index{Banach lattices!Order-Continuous Norm}
...
\index{Banach Lattices!Positive Operators}
\index{Banach Lattices!Lattice Homomorphisms}
\index{Banach Lattices!Regular Operators}
%% --
...
\index{Banach lattices!Complex Banach Lattices}
%% --
...
%% --
\[
	|h| = \sup\{ \mathrm{Re} \left( e^{\im\theta}h \right) \colon 0 \leq \theta \leq 2\pi \}.
\]
%% --
...
%% --
\[
M = \{\Re(e^{\im\theta}h) \colon 0 \leq \theta \leq 2\pi\}
\]
%% --
...
\index{Banach Lattices!Signum Operator}
%% --
...
%% --
\begin{enumerate}[\upshape (1), wide]
...
%\index{Center!of $\LE$}
\index{Banach Lattices!Center $ \mathcal{Z}(E) $}
%% --
