...
%% --
\chapter{Spectral Theory of Positive Semigroups on \texorpdfstring{W$^{*}$}{W*}-Algebras and their Preduals}\label{chap:d3}
...
\begin{enumerate}[label=\emph{Section \arabic*:}, wide, itemsep=1ex, parsep=.5ex]
