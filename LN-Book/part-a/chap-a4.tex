...
\item 
One can show that the abscissas of uniform, strong, and weak convergence of the Laplace transform%
\index{Laplace transform} 
coincide (see C-III, Theorem~I.2, last part of the proof). 
...
Define $g \coloneq  \int_0^\infty \mathrm{e}^{-\lambda t} T(t) f \,\dt$. 
...
\[{
T(t) \coloneq  (\mathrm{e}^{2\pi i n t} \exp(t A_n))_{n \in \N}
},\]
where
\[
A_n =
...
\index{stability!holomorphic semigroup}
