...
\ref{thm:a2-3.6-6}
\citet[Corollary 3]{bourgain:1980} proves that $H^{\infty}(D)$ has the Dunford-Pettis property and in \citet[Proposition III.1]{bourgain:1984}, that $H^{\infty}(D)$ is a
\marginpar{!!Im Buch: Bourgain 1984???}
