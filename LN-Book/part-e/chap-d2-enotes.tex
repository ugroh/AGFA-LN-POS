...
\item
\mycite{zbMATH01495754} has shown that strong and norm convergence for sequences of completely positive maps to the identity operator are equivalent on \WA-algebras (even on the larger class of \AW-algebras).
