...
\begin{enumerate}[\upshape (i), wide, labelindent=0.5em]
    ...
    On the other hand, the set of operators $\{\frac{1}{t} \int_{0}^{t} \exp(-\tau s(A))T(\tau) \diff{\tau} \colon 0 \leq t \leq T\}$ is bounded for every $T \geq 0$, hence in \eqref{eq:c3-2.15}(b) the boundedness for $t \to \infty$ is important.
