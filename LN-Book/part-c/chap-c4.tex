...
% Claude
\index{stability}
\index{stability!positive semigroups!Banach lattices|(}
%% --
...
%% KGKind
\index{exponentially stable}
\index{stability!exponentially}
...
%% --
%% KGKind
\index{eventually norm-continuous}
...
%% KGKIND
\index{uniformly stable}
\index{stability!uniformly}
\end{proposition}
%% --
\begin{proof}
...
%% KGKind
\index{stable semigroup}
\index{semigroup!stable}
...
%% KGKind
\index{quasi-compact!semigroup}
\index{semigroup!quasi-compact}
...
%% KGKind
\index{semigroup!Lp-space@$L^{p}$-space}
...
%
\index{periodic semigroup!Lp-space@$L^{p}$-space}
%
\index{asymptotic behavior!Lp-space@$L^{p}$-space}
%
% Claude
...
%% --
%
\index{example!cell division models}
%% KGKind
\index{population}
...
Now consider the operators $S_{\lambda} \colon E \to E \colon f \mapsto \epsilon_{\lambda} \otimes \Phi(f)$, $\lambda > 0$, where $\epsilon_{\lambda}$ denotes the function $s \mapsto e^{\lambda s}$ as an element of $L^{1}[-1,0]$, 
...
%
\index{retarded equation!generator}
%
\index{semigroup!retarded equation}
%
...
%
\index{retarded equation!well-posedness}
%
% Claude
...
%
\index{retarded equation!positivity}
...
%
\index{retarded equation!resolvent}
...
%
\index{retarded equation!spectrum}
...
%% --
%% KGKind
\index{retarded equation!spectral bound}
...
%
\index{retarded equation!stability}
%
...
% \index{Spectral bound!Characterization}
%
\index{retarded equation!stability condition}
...
%% KGKind
\index{characteristic equation!generalized}
...
%[Heijmans (1984), Sec.5]) 
%\marginpar{KGK: Heijmans 1984 fehlt im LV}
...
%
\index{retarded equation!examples}
%
\index{example!retarded equation}
...
\index{example!retarding functional}
%% --
...
%
\index{example!Dunford-Pettis property}
%
% Claude
...
%
\index{example!differential equation}
%
...
\index{example!integral operator}
