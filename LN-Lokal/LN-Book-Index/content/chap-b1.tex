...
\index{CoX@$C_{0}(X)$!Algebraic Structure}%
\index{CoX@$C_{0}(X)$!Order Structure}%
\index{CoX@$C_{0}(X)$!Ideals}
%% --
...
\index{CoX@$C_{0}(X)$!Linear Forms}
\index{CoX@$C_{0}(X)$!Positive linear forms}
\index{CoX@$C_{0}(X)$!Strictly positive linear Forms}
%% --
...
\index{CoX@$C_{0}(X)$!Linear Operators}%
\index{CoX@$C_{0}(X)$!Positive Linear Operators}%
\index{CoX@$C_{0}(X)$!Markov Operator}%
\index{CoX@$C_{0}(X)$!Lattice Homomorphisms}
%% --
