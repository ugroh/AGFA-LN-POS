...
\index{example!pseudo-resolvent}
	\begin{enumerate}[\upshape (i), wide, labelindent=.5em]
		\item 
...
\begin{theorem}\label{thm:c3-2.10}
	\index{cyclic!boundary spectrum}\index{spectrum!cyclic} 
...
\begin{corollary}\label{cor:c3-2.12}
    ...
    \index{cyclic}\index{spectrum!cyclic}.
\end{corollary}
%% --
\begin{proof}
...
\begin{examples}\label{ex:c3-3.4}
	...
	%% --
        ...
        \index{example!transport equation} 
...
\index{boundary spectrum!irreducible semigroup}
\index{resolvent!pole}
...
\index{spectrum!lattice homomorphism}
\index{semigroup!lattice homomorphisms} 
...
\begin{theorem}\label{thm:c3-4.2}
    \index{semigroup!lattice homomorphisms} 
    \index{cyclic!imaginary additively}\index{spectrum!cyclic} 
