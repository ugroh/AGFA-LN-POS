...
\index{Standard Examples!$n$-dimensional Diffusion Semigroup}
%% --
...
\[
    ...
    = q\left(\int_{0}^{\infty}  \mathrm{e}^{-\lambda s}T(s)g \ds\right) = q(h)
\]
%% --
...
\index{Standard Constructions!Tensor Product Semigroup}
...
\index{Standard Constructions!Commuting Semigroups}
%% --
